      ...
      <main className="pt-28 pb-16">
        <header className="mx-auto max-w-6xl px-6 text-center">
          <h1 className="text-4xl font-semibold tracking-tight sm:text-5xl">
            Family portrait art styles
          </h1>
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-[color:var(--color-ink-muted)]">
            Hand-painted, illustrated, sculpted, or studio-shot. Pick the finish, upload selfies,
            and FamilyShoot delivers a portrait that looks commissioned in about two minutes.
          </p>
        </header>
