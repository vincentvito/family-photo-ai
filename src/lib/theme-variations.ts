...
export const THEME_VARIATION_PROMPTS: Partial<Record<string, ThemeVariationPrompts>> = {
  ...
  "card-luxury-carved-number-birthday": [
    "Carved-number breakthrough poster: one child centered inside a large birthday-age number cut into an off-white textured paper wall, face and shoulder extending outside the number, soft blue balloons and white florals inside, tasteful wall typography from the provided card text only.",
    ...
    "Minimal magazine cover poster: oversized carved birthday age dominates the frame, child laughing naturally in dark denim or premium casual styling, warm side sunlight, subtle rim light, serif typography on the wall using supplied text, no sample names or sample ages.",
    "Close luxury paper-wall crop: tight 3:4 poster framing on the carved number opening, premium off-white texture, soft palette-matched balloons and white flowers, realistic shadows under extended limbs, natural colors, no tree shadows and no fake lighting.",
  ],
  "card-anniversary": [
