...
export const STYLES: readonly ArtStyle[] = [
  {
    ...
    related: [
      "oil-painting-family-portraits",
      "colored-pencil-family-portraits",
      "storybook-family-portraits",
    ],
  },
  {
    ...
    secondaryKeywords: [
      "custom oil painting family portrait",
      "family oil painting from photo",
      "classical family painting",
    ],
    image: "/samples/card-art-styles/oil-painting.jpg",
    shortDescription:
      "Visible brushwork, deep color, your family painted like an old-master commission.",
    related: [
  ...
  },
  {
    ...
    shortDescription:
      "Fine strokes, gentle color, the kind of drawing you keep on the fridge for years.",
    related: [
      "watercolor-family-portraits",
      "storybook-family-portraits",
      "oil-painting-family-portraits",
  ...
  },
  {
    ...
    secondaryKeywords: [
      ...
      "childrens book style family portrait",
      "illustrated family portrait",
    ],
    image: "/samples/card-art-styles/storybook.jpg",
    shortDescription:
      "Hand-drawn warmth, picture-book color. Your family as the heroes of a story.",
    related: [
      "watercolor-family-portraits",
      "colored-pencil-family-portraits",
      "clay-3d-family-portraits",
    ],
  },
  {
    ...
    secondaryKeywords: [
      "3d clay family portrait",
      "claymation family portrait",
      "cute 3d family illustration",
    ],
  ...
  },
  {
    ...
    secondaryKeywords: [
      "ai family photoshoot",
      "studio family portrait",
      "family photography style portrait",
    ],
    image: "/samples/card-art-styles/photoshoot.jpg",
    shortDescription:
      "Studio-lit, sharp, magazine-grade. Your family with a photographer-quality finish.",
    related: [
      "oil-painting-family-portraits",
      "clay-3d-family-portraits",
      "storybook-family-portraits",
