...
const samples = [
  ...
  },
  {
    ...
    w: 1600,
    h: 1200,
    palette: ["#d9d4cc", "#7a7670", "#2a2824"],
    caption: "Before",
    subtitle: "A phone snap",
  },
  {
    id: "after-1",
    w: 1600,
    h: 1200,
    palette: ["#f0e4cf", "#a67a52", "#2e231a"],
    caption: "After",
    subtitle: "Kitchen · Sunday",
  },
  {
    id: "before-2",
    w: 1600,
    h: 1200,
    palette: ["#cdc8bf", "#6a665f", "#22201c"],
    caption: "Before",
    subtitle: "Backyard sprint",
  },
  {
    id: "after-2",
    w: 1600,
    h: 1200,
    palette: ["#e8d3b2", "#8f5f3a", "#2b1f15"],
    caption: "After",
    subtitle: "Autumn light",
  },
  {
    id: "before-3",
    w: 1600,
    h: 1200,
    palette: ["#d4cfc6", "#746f68", "#1f1d1a"],
    caption: "Before",
    subtitle: "Christmas chaos",
  },
  {
    id: "after-3",
    w: 1600,
    h: 1200,
    palette: ["#ecd3b7", "#8b3c2f", "#22150f"],
    caption: "After",
    subtitle: "Holiday card",
  },
  ...
  },
  {
    ...
    w: 1400,
    h: 1400,
    palette: ["#d9c6a4", "#7a532f", "#241812"],
    caption: "Autumn cabin",
    subtitle: "",
  },
  {
    id: "g-3",
    w: 1800,
    h: 1200,
    palette: ["#eee2cb", "#907754", "#28201a"],
    caption: "Kinfolk kitchen",
    subtitle: "",
  },
  {
    id: "g-4",
    w: 1200,
    h: 1200,
    palette: ["#e3d4b8", "#7d674b", "#24201a"],
    caption: "Vintage Polaroid",
    subtitle: "",
  },
  {
    id: "g-5",
  ...
  },
  {
    ...
    w: 1200,
    h: 1600,
    palette: ["#eed4a8", "#7a5733", "#20170d"],
    caption: "Pixar family",
    subtitle: "",
  },
  {
    id: "g-9",
    w: 1400,
    h: 1400,
    palette: ["#e9dfc7", "#b89669", "#2a2319"],
    caption: "Wes Anderson",
    subtitle: "",
  },

  // Theme covers (4:5 aspect)
  {
    id: "theme-golden-hour-beach",
    w: 1200,
    h: 1500,
    palette: ["#f6e1b7", "#b07747", "#2b1d10"],
    caption: "Golden hour beach",
    subtitle: "Linen · sand",
  },
  {
    id: "theme-autumn-cabin",
    w: 1200,
    h: 1500,
    palette: ["#d7b88a", "#7c4a2b", "#1c120a"],
    caption: "Autumn cabin",
    subtitle: "Cedar · amber",
  },
  {
    id: "theme-kinfolk-kitchen",
    w: 1200,
    h: 1500,
    palette: ["#f1e7d1", "#9a7d58", "#28201a"],
    caption: "Kinfolk kitchen",
    subtitle: "Flour · morning",
  },
  {
    id: "theme-vintage-polaroid",
    w: 1200,
    h: 1500,
    palette: ["#e5d6b4", "#805e3c", "#24190f"],
    caption: "Vintage Polaroid",
    subtitle: "Faded · warm",
  },
  {
  ...
  {
    id: "theme-wes-anderson",
    w: 1200,
    h: 1500,
    palette: ["#f0e1b3", "#c6846f", "#2b1f19"],
    caption: "Wes Anderson",
    subtitle: "Symmetry",
  },
  {
  ...
  },
  {
    ...
    w: 1200,
    h: 1500,
    palette: ["#e5e3de", "#676461", "#0c0b0a"],
    caption: "Film noir",
    subtitle: "Shadows",
  },
  {
    id: "theme-christmas-morning",
    w: 1200,
    h: 1500,
    palette: ["#f1d4b4", "#a03e32", "#2a1410"],
    caption: "Christmas morning",
    subtitle: "Pajamas · tree",
  },
  {
    id: "theme-pixar",
    w: 1200,
    h: 1500,
    palette: ["#f4dba8", "#c97a4a", "#2c1a10"],
    caption: "Pixar family",
    subtitle: "Animated",
  },
  {
  ...
  },
  {
    ...
    w: 1200,
    h: 1500,
    palette: ["#ecc894", "#b23a3a", "#1e0c0c"],
    caption: "Superhero family",
    subtitle: "Capes · rooftop",
  },
  {
    id: "theme-cartoon",
    w: 1200,
    h: 1500,
    palette: ["#f1d487", "#cf6f34", "#221007"],
    caption: "Saturday cartoon",
    subtitle: "Primary colors",
  },
  {
    id: "theme-card-christmas",
    w: 1200,
    h: 1500,
    palette: ["#e8ceae", "#6d3930", "#1a0c0a"],
    caption: "Holiday card · Christmas",
    subtitle: "Wreath · snow",
  },
  {
    id: "theme-card-easter",
    w: 1200,
    h: 1500,
    palette: ["#f0d9cb", "#b48ea3", "#2a1f1f"],
    caption: "Holiday card · Easter",
    subtitle: "Tulips · morning",
  },
  {
    id: "theme-card-birthday",
    w: 1200,
    h: 1500,
    palette: ["#f5d8a8", "#c85a64", "#2a1318"],
    caption: "Birthday invitation",
    subtitle: "Candles · cake",
  },
];
