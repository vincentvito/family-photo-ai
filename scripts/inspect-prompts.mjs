...
const cases = [
  {
    label: "PHOTOREAL — golden-hour-beach",
    theme: getTheme("golden-hour-beach"),
    wardrobe: "linen in sandy tones, everyone barefoot",
    card: null,
  },
  { label: "STYLIZED — pixar-family", theme: getTheme("pixar-family"), wardrobe: null, card: null },
  {
    label: "CARD — card-christmas",
    theme: getTheme("card-christmas"),
    wardrobe: null,
    card: "The Vitali Family · 2026",
  },
  {
    label: "CUSTOM VIBE",
    theme: buildCustomTheme({
      description:
        "Everyone reading in a sunroom on a rainy afternoon, slate and wool, wet windows, quiet.",
      aspectRatio: "4:5",
    }),
    wardrobe: null,
    card: null,
